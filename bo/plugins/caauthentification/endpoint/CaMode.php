 ...
 * Access CaMode
 */
class WP_REST_CaMode_Controller extends WP_REST_Controller {
    ...
    public function register_routes() {
     /**
         ...
         */
        register_rest_route( $this->namespace, '/getmodes', array(
            
            
            array(
                'methods'         => 'POST',
                'callback'        => array( $this, 'get_items_mode' ),
     ...
     */
    public function get_items_mode( $request ) {
        
       
        $parameters = $request->get_params();
        $camodes=new CaModeEntity();
        $camodeslist=$camodes->get_ca_modes($parameters);
        return $camodeslist;
